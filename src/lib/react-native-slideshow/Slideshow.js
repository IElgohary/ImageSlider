...
export default class Slideshow extends Component {
  ...
  componentWillMount() {
    const handleEnd = this.release.bind(this);
    const handleMove = this.handleShouldPanResponder.bind(this);

    this._panResponder = PanResponder.create({
      onStartShouldSetPanResponder: handleMove,
  ...
  handleShouldPanResponder(evt, gestureState) {
